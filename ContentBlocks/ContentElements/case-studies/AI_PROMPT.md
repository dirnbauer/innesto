# Finish the Innesto graft: innesto/case-studies

You are inside the element directory `/Users/dirnbauer/projects/innesto/ContentBlocks/ContentElements/case-studies`.
The upstream shadcn registry component "Case Studies 2 - Case studies with quotes and metrics" (This component displays case studies highlighting user testimonials and key performance metrics such as satisfaction rates and ROI improvement. It features visual and text elements including user quotes, images, and company logos to illustrate the impact and effectiveness of a product or service.) was scaffolded
here; your job is the finishing pass that cannot be done mechanically.

## Upstream sources

### sources/case-studies2.tsx
```tsx
...
3. **assets/frontend.css** — port the component styles. Use ONLY the semantic
   ...
   every class with `.innesto-case-studies`. Honor
