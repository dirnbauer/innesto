# Finish the Innesto graft: innesto/stats-segmented-progress

You are inside the element directory `/Users/dirnbauer/projects/innesto/ContentBlocks/ContentElements/stats-segmented-progress`.
The upstream shadcn registry component "Stats with Segmented Progress" (A stats with segmented progress block.) was scaffolded
here; your job is the finishing pass that cannot be done mechanically.

## Upstream sources

### sources/stats-13.tsx
```tsx
"use client";
...
3. **assets/frontend.css** — port the component styles. Use ONLY the semantic
   ...
   every class with `.innesto-stats-segmented-progress`. Honor
