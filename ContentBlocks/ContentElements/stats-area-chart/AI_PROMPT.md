# Finish the Innesto graft: innesto/stats-area-chart

You are inside the element directory `/Users/dirnbauer/projects/innesto/ContentBlocks/ContentElements/stats-area-chart`.
The upstream shadcn registry component "Stats with Area Chart" (A stats with area chart block.) was scaffolded
here; your job is the finishing pass that cannot be done mechanically.

## Upstream sources

### sources/stats-10.tsx
```tsx
"use client";
...
3. **assets/frontend.css** — port the component styles. Use ONLY the semantic
   ...
   every class with `.innesto-stats-area-chart`. Honor
